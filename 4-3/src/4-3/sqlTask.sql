...
-- [回答]
select store_code, avg(quantity) from stock_table group by store_code having avg(quantity) >
...
VALUES
('M001' , 'マフラー' , 4500 , TO_DATE('2020-11-12', 'YYYY-MM-DD'));
...
SET
quantity = 10
update_day = TO_DATE('2020-11-12', 'YYYY-MM-DD')
WHERE
goods_code = 'S987'
AND
store_code = 'EA01'
